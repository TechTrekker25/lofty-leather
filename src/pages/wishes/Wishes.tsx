...
const sampleMessagesDataArray: TMessagesData[] = [
  {
    ...
    messageInParas: [
      "Hey there Sumi, it's your birthday! Wishing you the happiest of birthdays filled with all the things you love and cherish the most.",
      "On this special day, I want to celebrate the amazing person you are and the wonderful friend you've been for the past 4 years. Your friendship has brought joy, support, and countless cherished moments into my life, and I'm grateful for every single one.",
      "May this year be filled with happiness, good health, and exciting adventures. May you continue to shine as the remarkable person you are, and may your dreams and aspirations come true.",
      "Here's to another year of laughter, friendship, and unforgettable memories. Cheers to you,Sumi!",
    ],
  ...
  },
  {
    ...
    messageInParas: [
      ...
      "Once again, happy birthday, Sumi! Cheers to another year of laughter, love, and wonderful memories.",
      "Warm regards,",
      "Fizzie",
    ],
